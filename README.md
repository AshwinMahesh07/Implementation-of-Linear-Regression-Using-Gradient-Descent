...
3. Perform Gradient Descent,Predict output using the equation ŷ = w·x + b,Compute the Mean Squared Error (loss),Calculate gradients dw and db,Update parameters w and b
...
## Output:
```
final weight: 33671.51979690389
final bias : 97157.57273469678
```
<img width="1252" height="519" alt="image" src="https://github.com/user-attachments/assets/b463f9d2-f119-4c4b-ae26-bd51d6e8405d" />
